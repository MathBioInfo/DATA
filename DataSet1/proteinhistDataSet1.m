...
annotation('textbox', [0.01, 0.999999, 0.0, 0.0], 'String', "C", 'fontweight','bold', 'FontSize', 18)
...
set(gca,'xticklabel',labels(ikeep(order),:));
%set(gca,'TickLabelInterpreter','latex')
annotation('textbox', [0.01, 0.999999, 0.0, 0.0], 'String', "A", 'fontweight','bold', 'FontSize', 18)
